...
{
    [TestFixture]
    public class JobPlayerTests
    {
        private VpPlayer _player;

        public JobPlayerTests()
        {
        ...
        [Test]
        public void QKSuitedVs3ToStraitFlush()
        {
            var holds = _player.GetHolds(Card.Hand("KC","9H","QC","TH","8H"));
        ...
        [Test]
        public void FourToStraitFlush()
        {
            var holds = _player.GetHolds(Card.Hand("JD", "KD", "TD", "TS", "9D"));
